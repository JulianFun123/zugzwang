...
<template>
  ...
  <div class="w-4  h-full border border-neutral-200 rounded-full relative">
    ...
    />
    <div v-if="evaluation?.type === 'mate'" class="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] bg-neutral-800 border border-neutral-700 text-white px-1.5 rounded-full text-sm text-nowrap">
      M{{
